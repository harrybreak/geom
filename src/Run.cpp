...
//	vertices.push_back(Vertex<float32>(10, 12));
//	vertices.push_back(Vertex<float32>(2, 50));
//	vertices.push_back(Vertex<float32>(32, 25));
	// vertices.push_back(Vertex<float32>(50 + 10, 50 + 10));
	// vertices.push_back(Vertex<float32>(50 + 10, 50 + -10));
	// vertices.push_back(Vertex<float32>(50 + -10, 50 + -10));
	// vertices.push_back(Vertex<float32>(50 + -10, 50 + 10));
